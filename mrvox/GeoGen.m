...
vasc.filename = sprintf('GeoV_v%d_res%d_R%d_N%d_Int%.1f_Vf%d',Model.geo.vasc.Id,Model.geo.res,Model.geo.vasc.R*1e6, ...
    Model.geo.vasc.N,Model.geo.vasc.Inter*1e6,Model.geo.vasc.Vf*1e2);
cell.filename = sprintf('GeoC_v%d_c%d_res%d_R%d_N%d_Int%.1f_Vp%d_P%d_Rc%d_CInter%.f',Model.geo.vasc.Id, ...
    Model.geo.cell.Id,Model.geo.res,Model.geo.vasc.R*1e6,Model.geo.vasc.N,Model.geo.vasc.Inter*1e6,Model.geo.vasc.Vf*1e2,Model.geo.cell.Poro*1e2,Model.geo.cell.Rc*1e6,Model.geo.cell.Inter*1e6);
