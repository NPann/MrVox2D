...
if strcmp(para.RF.exc.phaMod,'lin')
    pha = ((too.inc-1) * para.RF.exc.phainc + Seq.RF.exc.pha0)*pi/180;
elseif strcmp(para.RF.exc.phaMod,'qua')
    pha = ((too.inc * (too.inc-1)/2) * para.RF.exc.phainc + Seq.RF.exc.pha0)*pi/180;
else
    fprintf('Phase increment mode unknown\n')
    return;
end
